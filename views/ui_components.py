...
class UIComponents:
    ...
    def render_main_content(
        ...
        with viz_tab:
            ...
            with col1:
                if st.checkbox("Show Contour plot A (Teal)", value=AppState.is_showing_contour_a(), key="show_contour_a"):
            ...
            with col2:
                if st.checkbox("Show Contour plot B (Orange)", value=AppState.is_showing_contour_b(), key="show_contour_b"):
            ...
            # Always show the opacity slider regardless of contour visibility
            opacity = st.slider(
