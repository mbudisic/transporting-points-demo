...
from controllers.pot_distance_calculator import POTDistanceCalculator  # Using the new POT-based calculator
...
def main():
    ...
    with main_content:
        ...
        UIComponents.render_main_content(
            ...
            POTDistanceCalculator  # Using the POT-based calculator
        )
